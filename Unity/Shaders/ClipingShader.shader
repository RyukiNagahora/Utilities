...
Shader "Unlit/ClipingShader"
{
    Properties {
        ...
        _ClipingZ ("Cliping Pos Z", float) = -1.49
        [Toggle] _IsBack("Is Back", Int) = 0
    }   
    SubShader {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o) {
            ...
            half f = _IsBack == 1 ? 1 : -1;
            float az = IN.worldPos.z * f;
            clip(az + (_ClipingZ * f * -1));
            // clip(az + (_ClipingZ * f * -1));
        }
        ENDCG
    }
